        ...
        public bool Process(out string ErrorMessage)
        {
            ...
            try
            {
                try
                {
                    ...
                    CodeNamespace ns = Processor.Process(_InputFile, _NameSpace, _ColType, _UseIPropertyNotifyChanged, _HidePrivateField);
                ...
                string OptionsLine = "// ";
                swend.WriteLine("// <auto-generated />");
                swend.WriteLine("// ------------------------------------------------------------------------------");
                swend.WriteLine("// XSD2Code generation options. ** Must be at the begining of the file **");
